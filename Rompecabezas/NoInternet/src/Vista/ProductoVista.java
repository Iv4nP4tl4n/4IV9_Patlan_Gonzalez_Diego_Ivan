...
public class ProductoVista extends JFrame {
    ...
    public ProductoVista() {
        setTitle("Sistema de Rompecabezas — Vista de Datos");
        setSize(950, 700);
    ...
    private void inicializarComponentes() {
        ...
        modeloTabla = new DefaultTableModel(
            new String[]{"ID", "Nombre", "Piezas", "Dificultad", "Estado", "Categoría", "Avance %"}, 0
        ) {
            @Override
    ...
    private JPanel crearPanelFormulario() {
        ...
        cmbTipoProducto = new JComboBox<>(new String[]{"ROMPECABEZAS"});
        ...
        panelComun.add(new JLabel("Piezas:"));
        txtPrecio = new JTextField();
        panelComun.add(txtPrecio);

        panelComun.add(new JLabel("Avance %:"));
        ...
        panelAlimento.add(new JLabel("Dificultad:"));
        txtFechaCaducidad = new JTextField();
        panelAlimento.add(txtFechaCaducidad);
        panelAlimento.add(new JLabel("Estado:"));
        ...
        panelCamposEspecificos.add(panelAlimento, "ROMPECABEZAS");
